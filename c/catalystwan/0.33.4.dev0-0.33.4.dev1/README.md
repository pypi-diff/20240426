# Comparing `tmp/catalystwan-0.33.4.dev0.tar.gz` & `tmp/catalystwan-0.33.4.dev1.tar.gz`
...
### Comparing `catalystwan-0.33.4.dev0/LICENSE` & `catalystwan-0.33.4.dev1/LICENSE`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/README.md` & `catalystwan-0.33.4.dev1/README.md`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/__init__.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/abstractions.py` & `catalystwan-0.33.4.dev1/catalystwan/abstractions.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/admin_tech_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/admin_tech_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/administration.py` & `catalystwan-0.33.4.dev1/catalystwan/api/administration.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/alarms_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/alarms_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/api_container.py` & `catalystwan-0.33.4.dev1/catalystwan/api/api_container.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/basic_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/basic_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/builders/feature_profiles/builder_factory.py` & `catalystwan-0.33.4.dev1/catalystwan/api/builders/feature_profiles/builder_factory.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/builders/feature_profiles/other.py` & `catalystwan-0.33.4.dev1/catalystwan/api/builders/feature_profiles/other.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/builders/feature_profiles/service.py` & `catalystwan-0.33.4.dev1/catalystwan/api/builders/feature_profiles/service.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/builders/feature_profiles/system.py` & `catalystwan-0.33.4.dev1/catalystwan/api/builders/feature_profiles/system.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/config_device_inventory_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/config_device_inventory_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/config_group_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/config_group_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/configuration_groups/parcel.py` & `catalystwan-0.33.4.dev1/catalystwan/api/configuration_groups/parcel.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/configuration_groups/parcels/cellular_controller.py` & `catalystwan-0.33.4.dev1/catalystwan/api/configuration_groups/parcels/cellular_controller.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/dashboard_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/dashboard_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/device_action_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/device_action_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/feature_profile_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/feature_profile_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/logs_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/logs_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/monitoring_status_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/monitoring_status_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/mtt_aaa_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/mtt_aaa_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/omp_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/omp_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/packet_capture_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/packet_capture_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/parcel_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/parcel_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/partition_manager_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/partition_manager_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/policy_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/policy_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/resource_pool_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/resource_pool_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/software_action_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/software_action_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/speedtest_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/speedtest_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/task_status_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/task_status_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/template_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/template_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/README.md` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/README.md`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/cli_template.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/cli_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/device_template/device_template.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/device_template/device_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/device_template/device_template_payload.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/device_template/device_template_payload.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/feature_template.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/feature_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/feature_template_field.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/feature_template_field.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/feature_template_payload.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/feature_template_payload.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_aaa_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_aaa_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_banner_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_banner_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_bfd_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_bfd_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_bgp_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_bgp_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_logging_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_logging_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_ntp_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_ntp_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_omp_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_omp_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_ospf.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_ospf.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_ospfv3.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_ospfv3.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_secure_internet_gateway.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_secure_internet_gateway.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_snmp_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_snmp_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_system.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_system.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_vpn_interface_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_vpn_interface_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/cisco_vpn_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/cisco_vpn_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/omp_vsmart_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/omp_vsmart_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/security_vsmart_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/security_vsmart_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/supported.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/supported.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/models/system_vsmart_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/models/system_vsmart_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/aaa/aaa_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/aaa/aaa_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/aaa/feature/aaa.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/aaa/feature/aaa.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/aaa/feature/accounting.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/aaa/feature/accounting.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/aaa/feature/radius.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/aaa/feature/radius.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/aaa/feature/tacacs.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/aaa/feature/tacacs.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/aaa/feature/user.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/aaa/feature/user.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/cisco_vpn/cisco_vpn_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/cisco_vpn/cisco_vpn_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/cisco_vpn/feature/cisco_vpn.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/cisco_vpn/feature/cisco_vpn.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/cisco_vpn/feature/dns.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/cisco_vpn/feature/dns.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/cisco_vpn/feature/ipv4route.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/cisco_vpn/feature/ipv4route.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/cisco_vpn/feature/ipv6route.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/cisco_vpn/feature/ipv6route.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/cisco_vpn/feature/mapping.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/cisco_vpn/feature/mapping.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/tenant/tenant.json.j2` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/tenant/tenant.json.j2`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/templates/payloads/tenant/tenant_model.py` & `catalystwan-0.33.4.dev1/catalystwan/api/templates/payloads/tenant/tenant_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/tenant_backup_restore_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/tenant_backup_restore_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/tenant_management_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/tenant_management_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/tenant_migration_api.py` & `catalystwan-0.33.4.dev1/catalystwan/api/tenant_migration_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/api/versions_utils.py` & `catalystwan-0.33.4.dev1/catalystwan/api/versions_utils.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/dataclasses.py` & `catalystwan-0.33.4.dev1/catalystwan/dataclasses.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/__init__.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/administration_user_and_group.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/administration_user_and_group.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/certificate_management_device.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/certificate_management_device.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/certificate_management_vmanage.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/certificate_management_vmanage.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/client.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/client.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/cluster_management.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/cluster_management.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/device/software_update.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/device/software_update.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/disaster_recovery.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/disaster_recovery.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/feature_profile/sdwan/other.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/feature_profile/sdwan/other.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/feature_profile/sdwan/policy_object.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/feature_profile/sdwan/policy_object.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/feature_profile/sdwan/service.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/feature_profile/sdwan/service.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/feature_profile/sdwan/system.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/feature_profile/sdwan/system.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/feature_profile/sdwan/transport.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/feature_profile/sdwan/transport.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/abstractions.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/abstractions.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/access_control_list.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/access_control_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/access_control_list_ipv6.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/access_control_list_ipv6.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/amp.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/amp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/control.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/control.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/device_access.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/device_access.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/device_access_ipv6.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/device_access_ipv6.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/hub_and_spoke.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/hub_and_spoke.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/mesh.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/mesh.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/qos_map.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/qos_map.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/rewrite.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/rewrite.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/rule_set.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/rule_set.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/security_group.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/security_group.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/traffic_data.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/traffic_data.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/vpn_membership.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/vpn_membership.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/definition/zone_based_firewall.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/definition/zone_based_firewall.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/app.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/app.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/app_probe.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/app_probe.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/as_path.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/as_path.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/class_map.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/class_map.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/color.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/color.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/community.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/community.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/data_ipv6_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/data_ipv6_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/data_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/data_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/expanded_community.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/expanded_community.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/fqdn.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/fqdn.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/geo_location.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/geo_location.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/ips_signature.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/ips_signature.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/ipv6_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/ipv6_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/local_app.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/local_app.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/local_domain.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/local_domain.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/mirror.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/mirror.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/policer.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/policer.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/port.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/port.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/preferred_color_group.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/preferred_color_group.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/protocol_name.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/protocol_name.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/region.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/region.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/site.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/site.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/sla.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/sla.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/threat_grid_api_key.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/threat_grid_api_key.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/tloc.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/tloc.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/trunkgroup.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/trunkgroup.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/url_allow_list.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/url_allow_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/url_block_list.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/url_block_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/vpn.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/vpn.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/list/zone.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/list/zone.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/security_template.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/security_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/vedge_template.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/vedge_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/policy/vsmart_template.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/policy/vsmart_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration/software_actions.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration/software_actions.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration_dashboard_status.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration_dashboard_status.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration_device_actions.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration_device_actions.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration_device_inventory.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration_device_inventory.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration_device_template.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration_device_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration_feature_profile.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration_feature_profile.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration_group.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration_group.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/configuration_settings.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/configuration_settings.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/endpoints_container.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/endpoints_container.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/misc.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/misc.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/monitoring/device_details.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/monitoring/device_details.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/monitoring/status.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/monitoring/status.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/real_time_monitoring/reboot_history.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/real_time_monitoring/reboot_history.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/sdavc_cloud_connector.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/sdavc_cloud_connector.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/tenant_backup_restore.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/tenant_backup_restore.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/tenant_management.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/tenant_management.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/tenant_migration.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/tenant_migration.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/endpoints/troubleshooting_tools/device_connectivity.py` & `catalystwan-0.33.4.dev1/catalystwan/endpoints/troubleshooting_tools/device_connectivity.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/exceptions.py` & `catalystwan-0.33.4.dev1/catalystwan/exceptions.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/integration_tests/feature_profile/sdwan/base.py` & `catalystwan-0.33.4.dev1/catalystwan/integration_tests/feature_profile/sdwan/base.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/integration_tests/feature_profile/sdwan/test_other.py` & `catalystwan-0.33.4.dev1/catalystwan/integration_tests/feature_profile/sdwan/test_other.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/integration_tests/feature_profile/sdwan/test_service.py` & `catalystwan-0.33.4.dev1/catalystwan/integration_tests/feature_profile/sdwan/test_service.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/integration_tests/feature_profile/sdwan/test_system.py` & `catalystwan-0.33.4.dev1/catalystwan/integration_tests/feature_profile/sdwan/test_system.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/integration_tests/feature_profile/sdwan/test_transport.py` & `catalystwan-0.33.4.dev1/catalystwan/integration_tests/feature_profile/sdwan/test_transport.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/integration_tests/test_config_migration.py` & `catalystwan-0.33.4.dev1/catalystwan/integration_tests/test_config_migration.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/integration_tests/test_find_template_values.py` & `catalystwan-0.33.4.dev1/catalystwan/integration_tests/test_find_template_values.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/logging.conf` & `catalystwan-0.33.4.dev1/catalystwan/logging.conf`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/common.py` & `catalystwan-0.33.4.dev1/catalystwan/models/common.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/config_migration.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/config_migration.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/docs/diagram.png` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/docs/diagram.png`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/README.md` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/README.md`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/builder.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/builder.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/common.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/common.py`
...
### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/parcel.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/parcel.py`
...
### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/other/thousandeyes.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/other/thousandeyes.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/other/ucse.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/other/ucse.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/__init__.py`
...
### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/app_probe.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/app_probe.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/application_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/application_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/as_path.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/as_path.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/color_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/color_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/data_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/data_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/expanded_community_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/expanded_community_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/fowarding_class.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/fowarding_class.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/ipv6_data_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/ipv6_data_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/ipv6_prefix_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/ipv6_prefix_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/policer.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/policer.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/prefered_group_color.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/prefered_group_color.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/prefix_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/prefix_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/sla_class.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/sla_class.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/standard_community.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/standard_community.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/tloc_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/policy/tloc_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/amp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/amp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/application_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/application_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/data_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/data_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/fqdn.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/fqdn.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/geolocation_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/geolocation_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/intrusion_prevention.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/intrusion_prevention.py`
...
### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/ips_signature.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/ips_signature.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/local_domain.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/local_domain.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/protocol_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/protocol_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/security_port.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/security_port.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/url.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/url.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/url_filtering.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/url_filtering.py`
...
### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/zone.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/policy_object/security/zone.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/__init__.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/acl.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/acl.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/appqoe.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/appqoe.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/bgp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/bgp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/dhcp_server.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/dhcp_server.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/eigrp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/eigrp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/lan/common.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/lan/common.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/lan/ethernet.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/lan/ethernet.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/lan/gre.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/lan/gre.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/lan/ipsec.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/lan/ipsec.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/lan/svi.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/lan/svi.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/lan/vpn.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/lan/vpn.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/multicast.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/multicast.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/object_tracker.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/object_tracker.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/ospf.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/ospf.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/ospfv3.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/ospfv3.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/route_policy.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/route_policy.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/service_insertion_attachment.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/service_insertion_attachment.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/switchport.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/switchport.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/tracker.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/tracker.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/service/wireless_lan.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/service/wireless_lan.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/__init__.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/aaa.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/aaa.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/banner.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/banner.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/basic.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/basic.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/bfd.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/bfd.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/global_parcel.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/global_parcel.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/logging_parcel.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/logging_parcel.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/mrf.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/mrf.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/ntp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/ntp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/omp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/omp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/security.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/security.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/system/snmp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/system/snmp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/transport/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/transport/__init__.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/transport/bgp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/transport/bgp.py`
...
### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/transport/cellular_controller.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/transport/cellular_controller.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/configuration/feature_profile/sdwan/transport/vpn_management.py` & `catalystwan-0.33.4.dev1/catalystwan/models/configuration/feature_profile/sdwan/transport/vpn_management.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/device_inventory.py` & `catalystwan-0.33.4.dev1/catalystwan/models/device_inventory.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/misc/application_protocols.py` & `catalystwan-0.33.4.dev1/catalystwan/models/misc/application_protocols.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/__init__.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/centralized.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/centralized.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/access_control_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/access_control_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/access_control_list_ipv6.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/access_control_list_ipv6.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/amp.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/amp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/control.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/control.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/device_access.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/device_access.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/device_access_ipv6.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/device_access_ipv6.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/hub_and_spoke.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/hub_and_spoke.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/mesh.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/mesh.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/qos_map.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/qos_map.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/rewrite.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/rewrite.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/rule_set.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/rule_set.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/security_group.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/security_group.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/traffic_data.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/traffic_data.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/vpn_membership.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/vpn_membership.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/definition/zone_based_firewall.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/definition/zone_based_firewall.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/app.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/app.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/app_probe.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/app_probe.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/as_path.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/as_path.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/class_map.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/class_map.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/color.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/color.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/communities.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/communities.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/data_ipv6_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/data_ipv6_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/data_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/data_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/geo_location.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/geo_location.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/ips_signature.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/ips_signature.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/ipv6_prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/ipv6_prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/local_app.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/local_app.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/local_domain.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/local_domain.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/mirror.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/mirror.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/policer.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/policer.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/port.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/port.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/preferred_color_group.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/preferred_color_group.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/prefix.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/prefix.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/protocol_name.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/protocol_name.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/region.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/region.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/site.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/site.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/sla.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/sla.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/threat_grid_api_key.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/threat_grid_api_key.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/tloc.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/tloc.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/trunkgroup.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/trunkgroup.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/url.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/url.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/vpn.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/vpn.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/list/zone.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/list/zone.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/localized.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/localized.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/policy.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/policy.py`
...
### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/policy_definition.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/policy_definition.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/policy_list.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/policy_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/policy/security.py` & `catalystwan-0.33.4.dev1/catalystwan/models/policy/security.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/templates.py` & `catalystwan-0.33.4.dev1/catalystwan/models/templates.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/models/tenant.py` & `catalystwan-0.33.4.dev1/catalystwan/models/tenant.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/response.py` & `catalystwan-0.33.4.dev1/catalystwan/response.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/session.py` & `catalystwan-0.33.4.dev1/catalystwan/session.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/config_migration/test_converter_chooser.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/config_migration/test_converter_chooser.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/config_migration/test_device_template_with_info.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/config_migration/test_device_template_with_info.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/config_migration/test_merge_parcels.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/config_migration/test_merge_parcels.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/config_migration/test_normalizer.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/config_migration/test_normalizer.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/banner_1.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/banner_1.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/basic/children.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/basic/children.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/basic/children_nested.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/basic/children_nested.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/basic/children_nested_datapath.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/basic/children_nested_datapath.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/cisco_bfd.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/cisco_bfd.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/complex_aaa.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/complex_aaa.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/complex_cisco_vpn.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/complex_cisco_vpn.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/default_cisco_system.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/default_cisco_system.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/iuo.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/iuo.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/omp_2.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/omp_2.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/definitions/omp_3.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/definitions/omp_3.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/models/__init__.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/models/__init__.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/models/cisco_aaa.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/models/cisco_aaa.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/models/cisco_bfd.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/models/cisco_bfd.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/models/cisco_vpn.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/models/cisco_vpn.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/models/omp_vsmart.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/models/omp_vsmart.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/basic/alias.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/basic/alias.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/basic/basic.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/basic/basic.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/basic/children.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/basic/children.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/basic/children_nested.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/basic/children_nested.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/basic/children_nested_datapath.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/basic/children_nested_datapath.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/basic/data_path.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/basic/data_path.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/cedge_aaa.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/cedge_aaa.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/cisco_banner.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/cisco_banner.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/cisco_bfd.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/cisco_bfd.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/cisco_system.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/cisco_system.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/cisco_vpn.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/cisco_vpn.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/schemas/omp-vsmart.json` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/schemas/omp-vsmart.json`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/test_chose_model.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/test_chose_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/test_deserialize_model.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/test_deserialize_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/test_generate_payload.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/test_generate_payload.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/templates/test_serialize_model.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/templates/test_serialize_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_admin_tech_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_admin_tech_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_administration.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_administration.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_alarms_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_alarms_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_cli_template.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_cli_template.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_creation_tools.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_creation_tools.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_device_action_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_device_action_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_devices_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_devices_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_endpoints.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_endpoints.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_feature_profile_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_feature_profile_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_feature_template_field.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_feature_template_field.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_logs_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_logs_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_models_common.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_models_common.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_monitoring_server_info.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_monitoring_server_info.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_monitoring_status_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_monitoring_status_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_mtt_aaa_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_mtt_aaa_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_omp_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_omp_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_packet_capture.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_packet_capture.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_partition_manager_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_partition_manager_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_response.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_response.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_session.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_session.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_software_action_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_software_action_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_speed_test_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_speed_test_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_task_status_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_task_status_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_templates.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_templates.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_tenant_backup_restore_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_tenant_backup_restore_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_tenant_management_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_tenant_management_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_tenant_migration_api.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_tenant_migration_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_typed_list.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_typed_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_version.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_version.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_version_utils.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_version_utils.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/tests/test_vmanage_auth.py` & `catalystwan-0.33.4.dev1/catalystwan/tests/test_vmanage_auth.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/typed_list.py` & `catalystwan-0.33.4.dev1/catalystwan/typed_list.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/aaa.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/aaa.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/appqoe.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/appqoe.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/banner.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/banner.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/basic.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/basic.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/bfd.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/bfd.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/bgp.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/bgp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/dhcp.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/dhcp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/eigrp.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/eigrp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/ethernet.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/ethernet.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/global_.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/global_.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/gre.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/gre.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/ipsec.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/ipsec.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/logging_.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/logging_.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/multicast.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/multicast.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/normalizer.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/normalizer.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/ntp.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/ntp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/omp.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/omp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/ospf.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/ospf.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/ospfv3.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/ospfv3.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/parcel_factory.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/parcel_factory.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/security.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/security.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/snmp.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/snmp.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/svi.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/svi.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/switchport.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/switchport.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/thousandeyes.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/thousandeyes.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/ucse.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/ucse.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/vpn.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/vpn.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/feature_template/wireless_lan.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/feature_template/wireless_lan.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/converters/policy/policy_lists.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/converters/policy/policy_lists.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/creators/config_pusher.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/creators/config_pusher.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/creators/strategy/parcels.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/creators/strategy/parcels.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/factories/feature_profile_api.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/factories/feature_profile_api.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/factories/parcel_pusher.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/factories/parcel_pusher.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/reverters/config_reverter.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/reverters/config_reverter.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/config_migration/steps/transform.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/config_migration/steps/transform.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/creation_tools.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/creation_tools.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/dashboard.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/dashboard.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/device_model.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/device_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/dict.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/dict.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/feature_template/choose_model.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/feature_template/choose_model.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/feature_template/find_template_values.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/feature_template/find_template_values.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/operation_status.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/operation_status.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/timezone.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/timezone.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/utils/upgrades_helper.py` & `catalystwan-0.33.4.dev1/catalystwan/utils/upgrades_helper.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/version.py` & `catalystwan-0.33.4.dev1/catalystwan/version.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/vmanage_auth.py` & `catalystwan-0.33.4.dev1/catalystwan/vmanage_auth.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/workflows/config_migration.py` & `catalystwan-0.33.4.dev1/catalystwan/workflows/config_migration.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/catalystwan/workflows/tenant_migration.py` & `catalystwan-0.33.4.dev1/catalystwan/workflows/tenant_migration.py`

 * *Files identical despite different names*

### Comparing `catalystwan-0.33.4.dev0/pyproject.toml` & `catalystwan-0.33.4.dev1/pyproject.toml`
...
### Comparing `catalystwan-0.33.4.dev0/setup.py` & `catalystwan-0.33.4.dev1/setup.py`
...
-{ 'name': 'catalystwan', 'version': '0.33.4.dev0', 'description': 'Cisco
...
### Comparing `catalystwan-0.33.4.dev0/PKG-INFO` & `catalystwan-0.33.4.dev1/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: catalystwan Version: 0.33.4.dev0 Summary: Cisco
