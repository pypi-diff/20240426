# Comparing `tmp/mongodb_orm-0.0.119.tar.gz` & `tmp/mongodb_orm-0.0.120.tar.gz`
...
## Comparing `mongodb_orm-0.0.119.tar` & `mongodb_orm-0.0.120.tar`
...
### Comparing `mongodb_orm-0.0.119/README.md` & `mongodb_orm-0.0.120/README.md`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/mongodb_orm/custom_urls/bread_urls.py` & `mongodb_orm-0.0.120/mongodb_orm/custom_urls/bread_urls.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/mongodb_orm/interfaces/base_mongodb_model.py` & `mongodb_orm-0.0.120/mongodb_orm/interfaces/base_mongodb_model.py`
...
### Comparing `mongodb_orm-0.0.119/mongodb_orm/interfaces/mongodb_model.py` & `mongodb_orm-0.0.120/mongodb_orm/interfaces/mongodb_model.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/mongodb_orm/interfaces/mongodb_model_events.py` & `mongodb_orm-0.0.120/mongodb_orm/interfaces/mongodb_model_events.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/mongodb_orm/management/commands/update_schema.py` & `mongodb_orm-0.0.120/mongodb_orm/management/commands/update_schema.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/mongodb_orm/utils/helpers.py` & `mongodb_orm-0.0.120/mongodb_orm/utils/helpers.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/mongodb_orm/views/mongodb_api_model_view.py` & `mongodb_orm-0.0.120/mongodb_orm/views/mongodb_api_model_view.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/mongodb_orm.egg-info/SOURCES.txt` & `mongodb_orm-0.0.120/mongodb_orm.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.119/setup.py` & `mongodb_orm-0.0.120/setup.py`
