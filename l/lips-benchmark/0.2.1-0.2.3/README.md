# Comparing `tmp/lips-benchmark-0.2.1.tar.gz` & `tmp/lips-benchmark-0.2.3.tar.gz`
...
### Comparing `lips-benchmark-0.2.1/lips/augmented_simulators/__init__.py` & `lips-benchmark-0.2.3/lips/augmented_simulators/__init__.py`
...
### Comparing `lips-benchmark-0.2.1/lips/benchmark/__init__.py` & `lips-benchmark-0.2.3/lips/benchmark/__init__.py`
...
### Comparing `lips-benchmark-0.2.1/lips/benchmark/wheelBenchmark.py` & `lips-benchmark-0.2.3/lips/benchmark/wheelBenchmark.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/config/__init__.py` & `lips-benchmark-0.2.3/lips/config/__init__.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/config/configmanager.py` & `lips-benchmark-0.2.3/lips/config/configmanager.py`
...
### Comparing `lips-benchmark-0.2.1/lips/dataset/__init__.py` & `lips-benchmark-0.2.3/lips/dataset/__init__.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/airfransDataSet.py` & `lips-benchmark-0.2.3/lips/dataset/airfransDataSet.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/dataSet.py` & `lips-benchmark-0.2.3/lips/dataset/dataSet.py`
...
### Comparing `lips-benchmark-0.2.1/lips/dataset/pneumaticWheelDataSet.py` & `lips-benchmark-0.2.3/lips/dataset/pneumaticWheelDataSet.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/powergridDataSet.py` & `lips-benchmark-0.2.3/lips/dataset/powergridDataSet.py`
...
### Comparing `lips-benchmark-0.2.1/lips/dataset/sampler.py` & `lips-benchmark-0.2.3/lips/dataset/sampler.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/scaler/powergrid_scaler.py` & `lips-benchmark-0.2.3/lips/dataset/scaler/powergrid_scaler.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/scaler/rolling_scaler.py` & `lips-benchmark-0.2.3/lips/dataset/scaler/rolling_scaler.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/scaler/standard_scaler.py` & `lips-benchmark-0.2.3/lips/dataset/scaler/standard_scaler.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/scaler/standard_scaler_iterative.py` & `lips-benchmark-0.2.3/lips/dataset/scaler/standard_scaler_iterative.py`
...
### Comparing `lips-benchmark-0.2.1/lips/dataset/scaler/standard_scaler_per_channel.py` & `lips-benchmark-0.2.3/lips/dataset/scaler/standard_scaler_per_channel.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/dataset/utils/powergrid_utils.py` & `lips-benchmark-0.2.3/lips/dataset/utils/powergrid_utils.py`
...
### Comparing `lips-benchmark-0.2.1/lips/evaluation/__init__.py` & `lips-benchmark-0.2.3/lips/evaluation/__init__.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/evaluation/airfrans_evaluation.py` & `lips-benchmark-0.2.3/lips/evaluation/airfrans_evaluation.py`
...
### Comparing `lips-benchmark-0.2.1/lips/evaluation/evaluation.py` & `lips-benchmark-0.2.3/lips/evaluation/evaluation.py`
...
### Comparing `lips-benchmark-0.2.1/lips/evaluation/pneumatic_evaluation.py` & `lips-benchmark-0.2.3/lips/evaluation/pneumatic_evaluation.py`
...
### Comparing `lips-benchmark-0.2.1/lips/evaluation/powergrid_evaluation.py` & `lips-benchmark-0.2.3/lips/evaluation/powergrid_evaluation.py`
...
### Comparing `lips-benchmark-0.2.1/lips/evaluation/utils.py` & `lips-benchmark-0.2.3/lips/evaluation/utils.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/logger/__init__.py` & `lips-benchmark-0.2.3/lips/logger/__init__.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/logger/customLogger.py` & `lips-benchmark-0.2.3/lips/logger/customLogger.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/ml_metrics/mean_absolute_error.py` & `lips-benchmark-0.2.3/lips/metrics/ml_metrics/mean_absolute_error.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/ml_metrics/mean_absolute_percentage_error.py` & `lips-benchmark-0.2.3/lips/metrics/ml_metrics/mean_absolute_percentage_error.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/ml_metrics/mean_squared_error.py` & `lips-benchmark-0.2.3/lips/metrics/ml_metrics/mean_squared_error.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/ml_metrics/metrics.py` & `lips-benchmark-0.2.3/lips/metrics/ml_metrics/metrics.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/ml_metrics/normalized_mean_squared_error.py` & `lips-benchmark-0.2.3/lips/metrics/ml_metrics/normalized_mean_squared_error.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/__init__.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/__init__.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/global_conservation.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/global_conservation.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/joule_law.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/joule_law.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/kirchhoff_law.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/kirchhoff_law.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/local_conservation.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/local_conservation.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/ohm_law.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/ohm_law.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/physics_compliances.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/physics_compliances.py`
...
### Comparing `lips-benchmark-0.2.1/lips/metrics/power_grid/verify_voltage_equality.py` & `lips-benchmark-0.2.3/lips/metrics/power_grid/verify_voltage_equality.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/physical_simulator/__init__.py` & `lips-benchmark-0.2.3/lips/physical_simulator/__init__.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/physical_simulator/dcApproximationAS.py` & `lips-benchmark-0.2.3/lips/physical_simulator/dcApproximationAS.py`
...
### Comparing `lips-benchmark-0.2.1/lips/physical_simulator/getfemSimulator.py` & `lips-benchmark-0.2.3/lips/physical_simulator/getfemSimulator.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/physical_simulator/grid2opSimulator.py` & `lips-benchmark-0.2.3/lips/physical_simulator/grid2opSimulator.py`
...
### Comparing `lips-benchmark-0.2.1/lips/physical_simulator/physicalSimulator.py` & `lips-benchmark-0.2.3/lips/physical_simulator/physicalSimulator.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/physical_simulator/physicsSolver.py` & `lips-benchmark-0.2.3/lips/physical_simulator/physicsSolver.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/plot/power_grid/__init__.py` & `lips-benchmark-0.2.3/lips/plot/power_grid/__init__.py`
...
### Comparing `lips-benchmark-0.2.1/lips/tests/configs/powergrid/benchmarks/l2rpn_neurips_2020_track1_small.ini` & `lips-benchmark-0.2.3/configurations/powergrid/benchmarks/l2rpn_case14_sandbox.ini`
...
### Comparing `lips-benchmark-0.2.1/lips/tests/configs/powergrid/simulators/tf_leapnet.ini` & `lips-benchmark-0.2.3/lips/tests/configs/powergrid/simulators/tf_leapnet.ini`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/tests/configs/powergrid/simulators/torch_fc.ini` & `lips-benchmark-0.2.3/lips/tests/configs/powergrid/simulators/torch_fc.ini`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips/utils.py` & `lips-benchmark-0.2.3/lips/utils.py`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/lips_benchmark.egg-info/SOURCES.txt` & `lips-benchmark-0.2.3/lips_benchmark.egg-info/SOURCES.txt`
...
### Comparing `lips-benchmark-0.2.1/lips_benchmark.egg-info/requires.txt` & `lips-benchmark-0.2.3/lips_benchmark.egg-info/requires.txt`
...
### Comparing `lips-benchmark-0.2.1/setup.cfg` & `lips-benchmark-0.2.3/setup.cfg`

 * *Files identical despite different names*

### Comparing `lips-benchmark-0.2.1/setup.py` & `lips-benchmark-0.2.3/setup.py`
