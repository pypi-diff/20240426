# Comparing `tmp/python-snippets-0.0.45.tar.gz` & `tmp/python-snippets-0.0.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "python-snippets-0.0.45.tar", last modified: Thu Apr 25 08:22:39 2024, max compression
+gzip compressed data, was "python-snippets-0.0.6.tar", last modified: Tue Nov  1 06:44:17 2022, max compression
```

## Comparing `python-snippets-0.0.45.tar` & `python-snippets-0.0.6.tar`

### file list

```diff
@@ -1,23 +1,16 @@
-drwxr-xr-x   0 chenhao    (501) staff       (20)        0 2024-04-25 08:22:39.600323 python-snippets-0.0.45/
--rw-r--r--   0 chenhao    (501) staff       (20)      405 2024-04-25 08:22:39.599902 python-snippets-0.0.45/PKG-INFO
--rw-r--r--   0 chenhao    (501) staff       (20)       98 2022-05-31 09:28:56.000000 python-snippets-0.0.45/README.md
-drwxr-xr-x   0 chenhao    (501) staff       (20)        0 2024-04-25 08:22:39.598813 python-snippets-0.0.45/python_snippets.egg-info/
--rw-r--r--   0 chenhao    (501) staff       (20)      405 2024-04-25 08:22:39.000000 python-snippets-0.0.45/python_snippets.egg-info/PKG-INFO
--rw-r--r--   0 chenhao    (501) staff       (20)      440 2024-04-25 08:22:39.000000 python-snippets-0.0.45/python_snippets.egg-info/SOURCES.txt
--rw-r--r--   0 chenhao    (501) staff       (20)        1 2024-04-25 08:22:39.000000 python-snippets-0.0.45/python_snippets.egg-info/dependency_links.txt
--rw-r--r--   0 chenhao    (501) staff       (20)       52 2024-04-25 08:22:39.000000 python-snippets-0.0.45/python_snippets.egg-info/requires.txt
--rw-r--r--   0 chenhao    (501) staff       (20)        9 2024-04-25 08:22:39.000000 python-snippets-0.0.45/python_snippets.egg-info/top_level.txt
--rw-r--r--   0 chenhao    (501) staff       (20)        1 2024-04-25 08:22:39.000000 python-snippets-0.0.45/python_snippets.egg-info/zip-safe
--rw-r--r--   0 chenhao    (501) staff       (20)       38 2024-04-25 08:22:39.600391 python-snippets-0.0.45/setup.cfg
--rwxr-xr-x   0 chenhao    (501) staff       (20)     1407 2024-02-04 07:32:57.000000 python-snippets-0.0.45/setup.py
-drwxr-xr-x   0 chenhao    (501) staff       (20)        0 2024-04-25 08:22:39.596282 python-snippets-0.0.45/snippets/
--rw-r--r--   0 chenhao    (501) staff       (20)      562 2024-03-07 03:20:54.000000 python-snippets-0.0.45/snippets/__init__.py
--rw-r--r--   0 chenhao    (501) staff       (20)     7200 2024-04-25 07:10:58.000000 python-snippets-0.0.45/snippets/decorators.py
--rw-r--r--   0 chenhao    (501) staff       (20)     2936 2024-02-04 07:37:02.000000 python-snippets-0.0.45/snippets/evaluate.py
--rw-r--r--   0 chenhao    (501) staff       (20)     3404 2024-04-11 07:13:40.000000 python-snippets-0.0.45/snippets/logs.py
--rw-r--r--   0 chenhao    (501) staff       (20)      560 2023-10-19 10:20:06.000000 python-snippets-0.0.45/snippets/mixin.py
--rw-r--r--   0 chenhao    (501) staff       (20)     1875 2024-03-07 02:56:24.000000 python-snippets-0.0.45/snippets/perf.py
--rw-r--r--   0 chenhao    (501) staff       (20)    12478 2024-04-25 08:18:12.000000 python-snippets-0.0.45/snippets/utils.py
-drwxr-xr-x   0 chenhao    (501) staff       (20)        0 2024-04-25 08:22:39.599461 python-snippets-0.0.45/tests/
--rw-r--r--   0 chenhao    (501) staff       (20)     2412 2024-04-22 08:12:09.000000 python-snippets-0.0.45/tests/test_decorators.py
--rw-r--r--   0 chenhao    (501) staff       (20)     2026 2024-04-25 08:20:44.000000 python-snippets-0.0.45/tests/test_utils.py
...
### Comparing `python-snippets-0.0.45/snippets/utils.py` & `python-snippets-0.0.6/snippets/utils.py`
