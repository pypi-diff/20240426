# Comparing `tmp/rubpy-7.0.2b0.tar.gz` & `tmp/rubpy-7.0.2b1.tar.gz`
...
### Comparing `rubpy-7.0.2b0/rubpy/methods/channels/create_channel_voice_chat.py` & `rubpy-7.0.2b1/rubpy/methods/channels/create_channel_voice_chat.py`
...
### Comparing `rubpy-7.0.2b0/rubpy/methods/chats/upload_avatar.py` & `rubpy-7.0.2b1/rubpy/methods/chats/upload_avatar.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/contacts/add_address_book.py` & `rubpy-7.0.2b1/rubpy/methods/contacts/add_address_book.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/contacts/delete_contact.py` & `rubpy-7.0.2b1/rubpy/methods/contacts/delete_contact.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/contacts/get_contacts.py` & `rubpy-7.0.2b1/rubpy/methods/contacts/get_contacts.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/contacts/get_contacts_updates.py` & `rubpy-7.0.2b1/rubpy/methods/contacts/get_contacts_updates.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/decorators/on_chat_updates.py` & `rubpy-7.0.2b1/rubpy/methods/decorators/on_chat_updates.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/decorators/on_message_updates.py` & `rubpy-7.0.2b1/rubpy/methods/decorators/on_message_updates.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/decorators/on_remove_notifications.py` & `rubpy-7.0.2b1/rubpy/methods/decorators/on_remove_notifications.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/decorators/on_show_activities.py` & `rubpy-7.0.2b1/rubpy/methods/decorators/on_show_activities.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/decorators/on_show_notifications.py` & `rubpy-7.0.2b1/rubpy/methods/decorators/on_show_notifications.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/__init__.py` & `rubpy-7.0.2b1/rubpy/methods/extras/__init__.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/ban_member.py` & `rubpy-7.0.2b1/rubpy/methods/extras/ban_member.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/get_info.py` & `rubpy-7.0.2b1/rubpy/methods/extras/get_info.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/get_object_by_username.py` & `rubpy-7.0.2b1/rubpy/methods/extras/get_object_by_username.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/get_profile_link_items.py` & `rubpy-7.0.2b1/rubpy/methods/extras/get_profile_link_items.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/get_related_objects.py` & `rubpy-7.0.2b1/rubpy/methods/extras/get_related_objects.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/get_transcription.py` & `rubpy-7.0.2b1/rubpy/methods/extras/get_transcription.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/join.py` & `rubpy-7.0.2b1/rubpy/methods/extras/join.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/leave_chat.py` & `rubpy-7.0.2b1/rubpy/methods/extras/leave_chat.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/report_object.py` & `rubpy-7.0.2b1/rubpy/methods/extras/report_object.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/search_global_objects.py` & `rubpy-7.0.2b1/rubpy/methods/extras/search_global_objects.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/transcribe_voice.py` & `rubpy-7.0.2b1/rubpy/methods/extras/transcribe_voice.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/extras/user_is_admin.py` & `rubpy-7.0.2b1/rubpy/methods/extras/user_is_admin.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/gif/add_to_my_gif_set.py` & `rubpy-7.0.2b1/rubpy/methods/gif/add_to_my_gif_set.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/__init__.py` & `rubpy-7.0.2b1/rubpy/methods/groups/__init__.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/add_group.py` & `rubpy-7.0.2b1/rubpy/methods/groups/add_group.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/add_group_members.py` & `rubpy-7.0.2b1/rubpy/methods/groups/add_group_members.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/ban_group_member.py` & `rubpy-7.0.2b1/rubpy/methods/groups/ban_group_member.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/create_group_voice_chat.py` & `rubpy-7.0.2b1/rubpy/methods/groups/create_group_voice_chat.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/delete_no_access_group_chat.py` & `rubpy-7.0.2b1/rubpy/methods/groups/delete_no_access_group_chat.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/edit_group_info.py` & `rubpy-7.0.2b1/rubpy/methods/groups/edit_group_info.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_banned_group_members.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_banned_group_members.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_admin_access_list.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_admin_access_list.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_admin_members.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_admin_members.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_all_members.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_all_members.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_default_access.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_default_access.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_info.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_info.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_link.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_link.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_mention_list.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_mention_list.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/get_group_voice_chat_updates.py` & `rubpy-7.0.2b1/rubpy/methods/groups/get_group_voice_chat_updates.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/group_preview_by_join_link.py` & `rubpy-7.0.2b1/rubpy/methods/groups/group_preview_by_join_link.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/join_group.py` & `rubpy-7.0.2b1/rubpy/methods/groups/join_group.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/leave_group_voice_chat.py` & `rubpy-7.0.2b1/rubpy/methods/groups/leave_group_voice_chat.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/set_group_admin.py` & `rubpy-7.0.2b1/rubpy/methods/groups/set_group_admin.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/set_group_default_access.py` & `rubpy-7.0.2b1/rubpy/methods/groups/set_group_default_access.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/set_group_link.py` & `rubpy-7.0.2b1/rubpy/methods/groups/set_group_link.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/groups/set_group_voice_chat_setting.py` & `rubpy-7.0.2b1/rubpy/methods/groups/set_group_voice_chat_setting.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/__init__.py` & `rubpy-7.0.2b1/rubpy/methods/messages/__init__.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/action_on_message_reaction.py` & `rubpy-7.0.2b1/rubpy/methods/messages/action_on_message_reaction.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/auto_delete_message.py` & `rubpy-7.0.2b1/rubpy/methods/messages/auto_delete_message.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/create_poll.py` & `rubpy-7.0.2b1/rubpy/methods/messages/create_poll.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/delete_messages.py` & `rubpy-7.0.2b1/rubpy/methods/messages/delete_messages.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/edit_message.py` & `rubpy-7.0.2b1/rubpy/methods/messages/edit_message.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/forward_messages.py` & `rubpy-7.0.2b1/rubpy/methods/messages/forward_messages.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/get_message_share_url.py` & `rubpy-7.0.2b1/rubpy/methods/messages/get_message_share_url.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/get_messages_by_id.py` & `rubpy-7.0.2b1/rubpy/methods/messages/get_messages_by_id.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/get_messages_interval.py` & `rubpy-7.0.2b1/rubpy/methods/messages/get_messages_interval.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/get_messages_updates.py` & `rubpy-7.0.2b1/rubpy/methods/messages/get_messages_updates.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/get_poll_option_voters.py` & `rubpy-7.0.2b1/rubpy/methods/messages/get_poll_option_voters.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/get_poll_status.py` & `rubpy-7.0.2b1/rubpy/methods/messages/get_poll_status.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/reaction.py` & `rubpy-7.0.2b1/rubpy/methods/messages/reaction.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/remove_reaction.py` & `rubpy-7.0.2b1/rubpy/methods/messages/remove_reaction.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/request_send_file.py` & `rubpy-7.0.2b1/rubpy/methods/messages/request_send_file.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_document.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_document.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_gif.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_gif.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_message.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_message.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_music.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_music.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_photo.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_photo.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_sticker.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_sticker.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_video.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_video.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_video_message.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_video_message.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/send_voice.py` & `rubpy-7.0.2b1/rubpy/methods/messages/send_voice.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/set_pin_message.py` & `rubpy-7.0.2b1/rubpy/methods/messages/set_pin_message.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/messages/vote_poll.py` & `rubpy-7.0.2b1/rubpy/methods/messages/vote_poll.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/__init__.py` & `rubpy-7.0.2b1/rubpy/methods/settings/__init__.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/delete_folder.py` & `rubpy-7.0.2b1/rubpy/methods/settings/delete_folder.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/get_blocked_users.py` & `rubpy-7.0.2b1/rubpy/methods/settings/get_blocked_users.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/get_folders.py` & `rubpy-7.0.2b1/rubpy/methods/settings/get_folders.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/get_my_sessions.py` & `rubpy-7.0.2b1/rubpy/methods/settings/get_my_sessions.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/get_privacy_setting.py` & `rubpy-7.0.2b1/rubpy/methods/settings/get_privacy_setting.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/get_suggested_folders.py` & `rubpy-7.0.2b1/rubpy/methods/settings/get_suggested_folders.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/get_two_passcode_status.py` & `rubpy-7.0.2b1/rubpy/methods/settings/get_two_passcode_status.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/set_setting.py` & `rubpy-7.0.2b1/rubpy/methods/settings/set_setting.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/setup_two_step_verification.py` & `rubpy-7.0.2b1/rubpy/methods/settings/setup_two_step_verification.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/terminate_session.py` & `rubpy-7.0.2b1/rubpy/methods/settings/terminate_session.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/update_profile.py` & `rubpy-7.0.2b1/rubpy/methods/settings/update_profile.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/settings/update_username.py` & `rubpy-7.0.2b1/rubpy/methods/settings/update_username.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/__init__.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/__init__.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/action_on_sticker_set.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/action_on_sticker_set.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/get_my_sticker_sets.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/get_my_sticker_sets.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/get_sticker_set_by_id.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/get_sticker_set_by_id.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/get_stickers_by_emoji.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/get_stickers_by_emoji.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/get_stickers_by_set_ids.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/get_stickers_by_set_ids.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/get_trend_sticker_sets.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/get_trend_sticker_sets.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/stickers/search_stickers.py` & `rubpy-7.0.2b1/rubpy/methods/stickers/search_stickers.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/users/check_user_username.py` & `rubpy-7.0.2b1/rubpy/methods/users/check_user_username.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/users/delete_user_chat.py` & `rubpy-7.0.2b1/rubpy/methods/users/delete_user_chat.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/users/get_me.py` & `rubpy-7.0.2b1/rubpy/methods/users/get_me.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/users/get_user_info.py` & `rubpy-7.0.2b1/rubpy/methods/users/get_user_info.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/users/set_block_user.py` & `rubpy-7.0.2b1/rubpy/methods/users/set_block_user.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/__init__.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/__init__.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/add_handler.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/add_handler.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/audio.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/audio.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/connect.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/connect.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/disconnect.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/disconnect.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/download.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/download.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/download_profile_picture.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/download_profile_picture.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/get_members.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/get_members.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/run.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/run.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/start.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/start.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/thumbnail.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/thumbnail.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/utilities/upload.py` & `rubpy-7.0.2b1/rubpy/methods/utilities/upload.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/voice_chat/join_voice_chat.py` & `rubpy-7.0.2b1/rubpy/methods/voice_chat/join_voice_chat.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/voice_chat/send_group_voice_chat_activity.py` & `rubpy-7.0.2b1/rubpy/methods/voice_chat/send_group_voice_chat_activity.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/methods/voice_chat/set_voice_chat_state.py` & `rubpy-7.0.2b1/rubpy/methods/voice_chat/set_voice_chat_state.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/network.py` & `rubpy-7.0.2b1/rubpy/network.py`
...
### Comparing `rubpy-7.0.2b0/rubpy/parser/markdown.py` & `rubpy-7.0.2b1/rubpy/parser/markdown.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/rubino/client.py` & `rubpy-7.0.2b1/rubpy/rubino/client.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/rubino/thumbnail.py` & `rubpy-7.0.2b1/rubpy/rubino/thumbnail.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/sessions/sqliteSession.py` & `rubpy-7.0.2b1/rubpy/sessions/sqliteSession.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/sessions/stringSession.py` & `rubpy-7.0.2b1/rubpy/sessions/stringSession.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/sync.py` & `rubpy-7.0.2b1/rubpy/sync.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/types/update.py` & `rubpy-7.0.2b1/rubpy/types/update.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy/utils.py` & `rubpy-7.0.2b1/rubpy/utils.py`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/rubpy.egg-info/PKG-INFO` & `rubpy-7.0.2b1/rubpy.egg-info/PKG-INFO`
...
### Comparing `rubpy-7.0.2b0/rubpy.egg-info/SOURCES.txt` & `rubpy-7.0.2b1/rubpy.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `rubpy-7.0.2b0/setup.py` & `rubpy-7.0.2b1/setup.py`
