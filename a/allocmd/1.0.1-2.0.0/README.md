# Comparing `tmp/allocmd-1.0.1.tar.gz` & `tmp/allocmd-2.0.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/allocmd-1.0.1.tar", last modified: Thu Apr 25 16:12:11 2024, max compression
+gzip compressed data, was "dist/allocmd-2.0.0.tar", last modified: Thu Apr 25 15:48:24 2024, max compression
```

## Comparing `allocmd-1.0.1.tar` & `allocmd-2.0.0.tar`

### file list

```diff
@@ -1,20 +1,20 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 16:12:11.000000 allocmd-1.0.1/
--rw-r--r--   0 runner    (1001) docker     (127)     5734 2024-04-25 16:12:11.000000 allocmd-1.0.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     4741 2024-04-25 16:12:00.000000 allocmd-1.0.1/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 16:12:11.000000 allocmd-1.0.1/allocmd/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-25 16:12:00.000000 allocmd-1.0.1/allocmd/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     7224 2024-04-25 16:12:00.000000 allocmd-1.0.1/allocmd/cli.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 16:12:11.000000 allocmd-1.0.1/allocmd/utilities/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-25 16:12:00.000000 allocmd-1.0.1/allocmd/utilities/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)       22 2024-04-25 16:12:00.000000 allocmd-1.0.1/allocmd/utilities/constants.py
--rw-r--r--   0 runner    (1001) docker     (127)       88 2024-04-25 16:12:00.000000 allocmd-1.0.1/allocmd/utilities/typings.py
--rw-r--r--   0 runner    (1001) docker     (127)    20019 2024-04-25 16:12:00.000000 allocmd-1.0.1/allocmd/utilities/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 16:12:11.000000 allocmd-1.0.1/allocmd.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     5734 2024-04-25 16:12:10.000000 allocmd-1.0.1/allocmd.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      358 2024-04-25 16:12:11.000000 allocmd-1.0.1/allocmd.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-25 16:12:10.000000 allocmd-1.0.1/allocmd.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       63 2024-04-25 16:12:10.000000 allocmd-1.0.1/allocmd.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (127)       44 2024-04-25 16:12:10.000000 allocmd-1.0.1/allocmd.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)        8 2024-04-25 16:12:10.000000 allocmd-1.0.1/allocmd.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-25 16:12:11.000000 allocmd-1.0.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      987 2024-04-25 16:12:00.000000 allocmd-1.0.1/setup.py
...
### Comparing `allocmd-1.0.1/PKG-INFO` & `allocmd-2.0.0/PKG-INFO`
...
### Comparing `allocmd-1.0.1/README.md` & `allocmd-2.0.0/README.md`
...
### Comparing `allocmd-1.0.1/allocmd/cli.py` & `allocmd-2.0.0/allocmd/cli.py`
...
### Comparing `allocmd-1.0.1/allocmd/utilities/utils.py` & `allocmd-2.0.0/allocmd/utilities/utils.py`
...
### Comparing `allocmd-1.0.1/allocmd.egg-info/PKG-INFO` & `allocmd-2.0.0/allocmd.egg-info/PKG-INFO`
...
### Comparing `allocmd-1.0.1/setup.py` & `allocmd-2.0.0/setup.py`
