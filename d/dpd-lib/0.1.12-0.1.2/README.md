# Comparing `tmp/dpd_lib-0.1.12.tar.gz` & `tmp/dpd_lib-0.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dpd_lib-0.1.12.tar", last modified: Fri Apr 26 18:49:28 2024, max compression
+gzip compressed data, was "dpd_lib-0.1.2.tar", last modified: Tue Apr 23 18:44:20 2024, max compression
```

## Comparing `dpd_lib-0.1.12.tar` & `dpd_lib-0.1.2.tar`

### file list

```diff
@@ -1,19 +1,19 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-04-26 18:49:28.143165 dpd_lib-0.1.12/
--rw-r--r--   0 root         (0) root         (0)     2102 2024-04-26 18:49:28.143165 dpd_lib-0.1.12/PKG-INFO
--rw-rw-rw-   0 root         (0) root         (0)     1285 2024-04-26 18:47:34.000000 dpd_lib-0.1.12/PYPI.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-04-26 18:49:28.143165 dpd_lib-0.1.12/dpd_lib/
--rw-rw-rw-   0 root         (0) root         (0)        0 2024-04-26 18:49:21.000000 dpd_lib-0.1.12/dpd_lib/__init__.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-04-26 18:49:28.143165 dpd_lib-0.1.12/dpd_lib/client/
--rw-rw-rw-   0 root         (0) root         (0)        0 2024-04-26 18:49:21.000000 dpd_lib-0.1.12/dpd_lib/client/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      812 2024-04-26 18:47:34.000000 dpd_lib-0.1.12/dpd_lib/client/exceptions.py
--rw-rw-rw-   0 root         (0) root         (0)    11658 2024-04-26 18:47:34.000000 dpd_lib-0.1.12/dpd_lib/client/influx.py
--rw-rw-rw-   0 root         (0) root         (0)     1238 2024-04-26 18:47:34.000000 dpd_lib-0.1.12/dpd_lib/config.py
--rw-rw-rw-   0 root         (0) root         (0)      690 2024-04-26 18:47:34.000000 dpd_lib-0.1.12/dpd_lib/models.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-04-26 18:49:28.143165 dpd_lib-0.1.12/dpd_lib.egg-info/
--rw-r--r--   0 root         (0) root         (0)     2102 2024-04-26 18:49:28.000000 dpd_lib-0.1.12/dpd_lib.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      313 2024-04-26 18:49:28.000000 dpd_lib-0.1.12/dpd_lib.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2024-04-26 18:49:28.000000 dpd_lib-0.1.12/dpd_lib.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)      100 2024-04-26 18:49:28.000000 dpd_lib-0.1.12/dpd_lib.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)        8 2024-04-26 18:49:28.000000 dpd_lib-0.1.12/dpd_lib.egg-info/top_level.txt
--rw-rw-rw-   0 root         (0) root         (0)      980 2024-04-26 18:47:34.000000 dpd_lib-0.1.12/pyproject.toml
--rw-r--r--   0 root         (0) root         (0)       38 2024-04-26 18:49:28.143165 dpd_lib-0.1.12/setup.cfg
...
### Comparing `dpd_lib-0.1.12/PKG-INFO` & `dpd_lib-0.1.2/PKG-INFO`
...
### Comparing `dpd_lib-0.1.12/PYPI.md` & `dpd_lib-0.1.2/PYPI.md`

 * *Files identical despite different names*

### Comparing `dpd_lib-0.1.12/dpd_lib/client/exceptions.py` & `dpd_lib-0.1.2/dpd_lib/client/exceptions.py`

 * *Files identical despite different names*

### Comparing `dpd_lib-0.1.12/dpd_lib/client/influx.py` & `dpd_lib-0.1.2/dpd_lib/client/influx.py`
...
### Comparing `dpd_lib-0.1.12/dpd_lib/config.py` & `dpd_lib-0.1.2/dpd_lib/config.py`

 * *Files identical despite different names*

### Comparing `dpd_lib-0.1.12/dpd_lib/models.py` & `dpd_lib-0.1.2/dpd_lib/models.py`

 * *Files identical despite different names*

### Comparing `dpd_lib-0.1.12/dpd_lib.egg-info/PKG-INFO` & `dpd_lib-0.1.2/dpd_lib.egg-info/PKG-INFO`
...
### Comparing `dpd_lib-0.1.12/pyproject.toml` & `dpd_lib-0.1.2/pyproject.toml`
