# Comparing `tmp/think_sql-0.7.3.tar.gz` & `tmp/think_sql-0.7.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "think_sql-0.7.3.tar", max compression
+gzip compressed data, was "think_sql-0.7.4.tar", max compression
```

## Comparing `think_sql-0.7.3.tar` & `think_sql-0.7.4.tar`

### file list

```diff
@@ -1,20 +1,20 @@
--rw-r--r--   0        0        0     1381 2024-04-19 08:37:05.498657 think_sql-0.7.3/pyproject.toml
--rw-r--r--   0        0        0    16301 2024-04-16 02:14:07.551128 think_sql-0.7.3/README.md
--rw-r--r--   0        0        0     1139 2024-04-19 08:37:22.016945 think_sql-0.7.3/think_sql/__init__.py
--rw-r--r--   0        0        0       70 2024-04-15 09:26:44.219328 think_sql-0.7.3/think_sql/dm/__init__.py
--rw-r--r--   0        0        0     4689 2024-04-18 06:56:42.003796 think_sql-0.7.3/think_sql/dm/db.py
--rw-r--r--   0        0        0    28774 2024-04-19 07:27:02.884930 think_sql-0.7.3/think_sql/dm/table.py
--rw-r--r--   0        0        0     5674 2024-04-19 07:27:25.515112 think_sql-0.7.3/think_sql/dm/util.py
--rw-r--r--   0        0        0       76 2024-04-15 05:46:17.205661 think_sql-0.7.3/think_sql/mysql/__init__.py
--rw-r--r--   0        0        0     4027 2024-04-16 02:15:08.168259 think_sql-0.7.3/think_sql/mysql/db.py
--rw-r--r--   0        0        0     2837 2024-01-19 04:32:29.868664 think_sql-0.7.3/think_sql/mysql/parse.py
--rw-r--r--   0        0        0    27967 2024-04-15 05:46:51.928111 think_sql-0.7.3/think_sql/mysql/sql_helper.py
--rw-r--r--   0        0        0    25448 2024-04-16 00:54:40.974556 think_sql-0.7.3/think_sql/mysql/table.py
--rw-r--r--   0        0        0     3475 2024-04-15 06:24:27.467941 think_sql-0.7.3/think_sql/mysql/util.py
--rw-r--r--   0        0        0        0 2024-04-11 01:32:11.713368 think_sql-0.7.3/think_sql/tool/__init__.py
--rw-r--r--   0        0        0     3923 2024-04-16 00:57:11.045987 think_sql-0.7.3/think_sql/tool/base.py
--rw-r--r--   0        0        0     2360 2024-04-15 05:48:22.966562 think_sql-0.7.3/think_sql/tool/cache.py
--rw-r--r--   0        0        0     3713 2024-04-16 01:02:24.858779 think_sql-0.7.3/think_sql/tool/interface.py
--rw-r--r--   0        0        0     3379 2024-04-16 02:14:57.886205 think_sql-0.7.3/think_sql/tool/util.py
--rw-r--r--   0        0        0    17944 1970-01-01 00:00:00.000000 think_sql-0.7.3/setup.py
--rw-r--r--   0        0        0    17160 1970-01-01 00:00:00.000000 think_sql-0.7.3/PKG-INFO
...
### Comparing `think_sql-0.7.3/pyproject.toml` & `think_sql-0.7.4/pyproject.toml`
...
### Comparing `think_sql-0.7.3/README.md` & `think_sql-0.7.4/README.md`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/__init__.py` & `think_sql-0.7.4/think_sql/__init__.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/dm/db.py` & `think_sql-0.7.4/think_sql/dm/db.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/dm/table.py` & `think_sql-0.7.4/think_sql/dm/table.py`
...
### Comparing `think_sql-0.7.3/think_sql/dm/util.py` & `think_sql-0.7.4/think_sql/dm/util.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/mysql/db.py` & `think_sql-0.7.4/think_sql/mysql/db.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/mysql/parse.py` & `think_sql-0.7.4/think_sql/mysql/parse.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/mysql/sql_helper.py` & `think_sql-0.7.4/think_sql/mysql/sql_helper.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/mysql/table.py` & `think_sql-0.7.4/think_sql/mysql/table.py`
...
### Comparing `think_sql-0.7.3/think_sql/mysql/util.py` & `think_sql-0.7.4/think_sql/mysql/util.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/tool/base.py` & `think_sql-0.7.4/think_sql/tool/base.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/tool/cache.py` & `think_sql-0.7.4/think_sql/tool/cache.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/tool/interface.py` & `think_sql-0.7.4/think_sql/tool/interface.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/think_sql/tool/util.py` & `think_sql-0.7.4/think_sql/tool/util.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.3/setup.py` & `think_sql-0.7.4/setup.py`
...
### Comparing `think_sql-0.7.3/PKG-INFO` & `think_sql-0.7.4/PKG-INFO`
