# Comparing `tmp/semantha_sdk-7.1.0.tar.gz` & `tmp/semantha_sdk-7.1.1.tar.gz`
...
### Comparing `semantha_sdk-7.1.0/CHANGELOG.md` & `semantha_sdk-7.1.1/CHANGELOG.md`
...
### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/bulkdomains_documenttypes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/bulkdomains_documenttypes.py`
...
### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/bulkmodel_namedentities.py` & `semantha_sdk-7.1.1/semantha_sdk/api/bulkmodel_namedentities.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/bulkmodel_rules.py` & `semantha_sdk-7.1.1/semantha_sdk/api/bulkmodel_rules.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/bulkmodel_stopwords.py` & `semantha_sdk-7.1.1/semantha_sdk/api/bulkmodel_stopwords.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/bulkmodel_synonyms.py` & `semantha_sdk-7.1.1/semantha_sdk/api/bulkmodel_synonyms.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/bulkmodelclass_instances.py` & `semantha_sdk-7.1.1/semantha_sdk/api/bulkmodelclass_instances.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/celltypes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/celltypes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/child_extractorclasses.py` & `semantha_sdk-7.1.1/semantha_sdk/api/child_extractorclasses.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/clone.py` & `semantha_sdk-7.1.1/semantha_sdk/api/clone.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/clusters.py` & `semantha_sdk-7.1.1/semantha_sdk/api/clusters.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/currentuser.py` & `semantha_sdk-7.1.1/semantha_sdk/api/currentuser.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/diff.py` & `semantha_sdk-7.1.1/semantha_sdk/api/diff.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/docclass_customfields.py` & `semantha_sdk-7.1.1/semantha_sdk/api/docclass_customfields.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/docclass_documentclasses.py` & `semantha_sdk-7.1.1/semantha_sdk/api/docclass_documentclasses.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/docclass_referencedocuments.py` & `semantha_sdk-7.1.1/semantha_sdk/api/docclass_referencedocuments.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/documentannotations.py` & `semantha_sdk-7.1.1/semantha_sdk/api/documentannotations.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/documentclass.py` & `semantha_sdk-7.1.1/semantha_sdk/api/documentclass.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/documentclasses.py` & `semantha_sdk-7.1.1/semantha_sdk/api/documentclasses.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/documents.py` & `semantha_sdk-7.1.1/semantha_sdk/api/documents.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/documenttype.py` & `semantha_sdk-7.1.1/semantha_sdk/api/documenttype.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/documenttypes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/documenttypes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/domain.py` & `semantha_sdk-7.1.1/semantha_sdk/api/domain.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/domains.py` & `semantha_sdk-7.1.1/semantha_sdk/api/domains.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/info.py` & `semantha_sdk-7.1.1/semantha_sdk/api/info.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/languages.py` & `semantha_sdk-7.1.1/semantha_sdk/api/languages.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_attributes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_attributes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_backups.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_backups.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_boostword.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_boostword.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_boostwords.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_boostwords.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_dataproperties.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_dataproperties.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_dataproperty.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_dataproperty.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_datatypes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_datatypes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_domain.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_domain.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_domains.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_domains.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_extractorclass.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_extractorclass.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_extractorclasses.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_extractorclasses.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_extractors.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_extractors.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_extractortypes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_extractortypes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_formatters.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_formatters.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_metadata.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_metadata.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_metadatatypes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_metadatatypes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_namedentities.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_namedentities.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_namedentity.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_namedentity.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_objectproperties.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_objectproperties.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_onemetadata.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_onemetadata.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_regex.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_regex.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_regexes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_regexes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_relation.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_relation.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_relations.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_relations.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_rule.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_rule.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_rulefunctions.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_rulefunctions.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_rules.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_rules.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_stopword.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_stopword.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_stopwords.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_stopwords.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_synonym.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_synonym.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/model_synonyms.py` & `semantha_sdk-7.1.1/semantha_sdk/api/model_synonyms.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelclasses.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelclasses.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelinstances.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelinstances.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelont_attribute.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelont_attribute.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelont_attributes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelont_attributes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelont_class.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelont_class.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelont_classes.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelont_classes.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelont_instance.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelont_instance.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelont_instances.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelont_instances.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/modelontclass_instances.py` & `semantha_sdk-7.1.1/semantha_sdk/api/modelontclass_instances.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/namedentities.py` & `semantha_sdk-7.1.1/semantha_sdk/api/namedentities.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/paragraph.py` & `semantha_sdk-7.1.1/semantha_sdk/api/paragraph.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/paragraphs.py` & `semantha_sdk-7.1.1/semantha_sdk/api/paragraphs.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/referencedocument.py` & `semantha_sdk-7.1.1/semantha_sdk/api/referencedocument.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/referencedocuments.py` & `semantha_sdk-7.1.1/semantha_sdk/api/referencedocuments.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/references.py` & `semantha_sdk-7.1.1/semantha_sdk/api/references.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/roles.py` & `semantha_sdk-7.1.1/semantha_sdk/api/roles.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/semantha_api.py` & `semantha_sdk-7.1.1/semantha_sdk/api/semantha_api.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/sentence.py` & `semantha_sdk-7.1.1/semantha_sdk/api/sentence.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/sentences.py` & `semantha_sdk-7.1.1/semantha_sdk/api/sentences.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/settings.py` & `semantha_sdk-7.1.1/semantha_sdk/api/settings.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/similaritymatrix.py` & `semantha_sdk-7.1.1/semantha_sdk/api/similaritymatrix.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/similaritymatrix_cluster.py` & `semantha_sdk-7.1.1/semantha_sdk/api/similaritymatrix_cluster.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/statistic.py` & `semantha_sdk-7.1.1/semantha_sdk/api/statistic.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/summarizations.py` & `semantha_sdk-7.1.1/semantha_sdk/api/summarizations.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/tag.py` & `semantha_sdk-7.1.1/semantha_sdk/api/tag.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/tag_referencedocuments.py` & `semantha_sdk-7.1.1/semantha_sdk/api/tag_referencedocuments.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/tags.py` & `semantha_sdk-7.1.1/semantha_sdk/api/tags.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/transactions.py` & `semantha_sdk-7.1.1/semantha_sdk/api/transactions.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/api/validation.py` & `semantha_sdk-7.1.1/semantha_sdk/api/validation.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/__init__.py` & `semantha_sdk-7.1.1/semantha_sdk/model/__init__.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/annotation_cell.py` & `semantha_sdk-7.1.1/semantha_sdk/model/annotation_cell.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/annotation_page.py` & `semantha_sdk-7.1.1/semantha_sdk/model/annotation_page.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/argument.py` & `semantha_sdk-7.1.1/semantha_sdk/model/argument.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/attribute.py` & `semantha_sdk-7.1.1/semantha_sdk/model/attribute.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/boost_word.py` & `semantha_sdk-7.1.1/semantha_sdk/model/boost_word.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/class_bulk.py` & `semantha_sdk-7.1.1/semantha_sdk/model/class_bulk.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/classes_overview.py` & `semantha_sdk-7.1.1/semantha_sdk/model/classes_overview.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/clazz.py` & `semantha_sdk-7.1.1/semantha_sdk/model/clazz.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/clustered_document.py` & `semantha_sdk-7.1.1/semantha_sdk/model/clustered_document.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/clustering_response.py` & `semantha_sdk-7.1.1/semantha_sdk/model/clustering_response.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/complex_property.py` & `semantha_sdk-7.1.1/semantha_sdk/model/complex_property.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/condition.py` & `semantha_sdk-7.1.1/semantha_sdk/model/condition.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/condition_value.py` & `semantha_sdk-7.1.1/semantha_sdk/model/condition_value.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/data_property.py` & `semantha_sdk-7.1.1/semantha_sdk/model/data_property.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_class.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_class.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_class_bulk.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_class_bulk.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_class_node.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_class_node.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_cluster.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_cluster.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_information.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_information.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_type.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_type.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_type_change.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_type_change.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/document_type_config.py` & `semantha_sdk-7.1.1/semantha_sdk/model/document_type_config.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/expression.py` & `semantha_sdk-7.1.1/semantha_sdk/model/expression.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/extraction_area.py` & `semantha_sdk-7.1.1/semantha_sdk/model/extraction_area.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/extraction_file.py` & `semantha_sdk-7.1.1/semantha_sdk/model/extraction_file.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/extractor.py` & `semantha_sdk-7.1.1/semantha_sdk/model/extractor.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/extractor_attribute.py` & `semantha_sdk-7.1.1/semantha_sdk/model/extractor_attribute.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/extractor_class.py` & `semantha_sdk-7.1.1/semantha_sdk/model/extractor_class.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/extractor_class_overview.py` & `semantha_sdk-7.1.1/semantha_sdk/model/extractor_class_overview.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/features.py` & `semantha_sdk-7.1.1/semantha_sdk/model/features.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/instance.py` & `semantha_sdk-7.1.1/semantha_sdk/model/instance.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/instance_overview.py` & `semantha_sdk-7.1.1/semantha_sdk/model/instance_overview.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/linked_instance.py` & `semantha_sdk-7.1.1/semantha_sdk/model/linked_instance.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/matrix_row.py` & `semantha_sdk-7.1.1/semantha_sdk/model/matrix_row.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/model_class.py` & `semantha_sdk-7.1.1/semantha_sdk/model/model_class.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/model_instance.py` & `semantha_sdk-7.1.1/semantha_sdk/model/model_instance.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/page.py` & `semantha_sdk-7.1.1/semantha_sdk/model/page.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/paragraph.py` & `semantha_sdk-7.1.1/semantha_sdk/model/paragraph.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/process_information.py` & `semantha_sdk-7.1.1/semantha_sdk/model/process_information.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/reference.py` & `semantha_sdk-7.1.1/semantha_sdk/model/reference.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/reference_documents_response_container.py` & `semantha_sdk-7.1.1/semantha_sdk/model/reference_documents_response_container.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/relation.py` & `semantha_sdk-7.1.1/semantha_sdk/model/relation.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/response_meta_info.py` & `semantha_sdk-7.1.1/semantha_sdk/model/response_meta_info.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/rule.py` & `semantha_sdk-7.1.1/semantha_sdk/model/rule.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/rule_overview.py` & `semantha_sdk-7.1.1/semantha_sdk/model/rule_overview.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/semantic_model.py` & `semantha_sdk-7.1.1/semantha_sdk/model/semantic_model.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/sentence.py` & `semantha_sdk-7.1.1/semantha_sdk/model/sentence.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/settings.py` & `semantha_sdk-7.1.1/semantha_sdk/model/settings.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/smart_cluster_response_container.py` & `semantha_sdk-7.1.1/semantha_sdk/model/smart_cluster_response_container.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/smart_cluster_semi_supervised_request.py` & `semantha_sdk-7.1.1/semantha_sdk/model/smart_cluster_semi_supervised_request.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/statistic.py` & `semantha_sdk-7.1.1/semantha_sdk/model/statistic.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/model/synonym.py` & `semantha_sdk-7.1.1/semantha_sdk/model/synonym.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/rest/rest_client.py` & `semantha_sdk-7.1.1/semantha_sdk/rest/rest_client.py`
...
### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/__init__.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/__init__.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/compare/__init__.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/compare/__init__.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/customization.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/customization.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/domain/__init__.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/domain/__init__.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/library/__init__.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/library/__init__.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/library/document.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/library/document.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/library/documentiter.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/library/documentiter.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/library/documenttags.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/library/documenttags.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/library/metadata.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/library/metadata.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/library/reference.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/library/reference.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/library/tags.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/library/tags.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/ranking/hybrid.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/ranking/hybrid.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/semantha_sdk/semantha/ranking/sparse.py` & `semantha_sdk-7.1.1/semantha_sdk/semantha/ranking/sparse.py`

 * *Files identical despite different names*

### Comparing `semantha_sdk-7.1.0/PKG-INFO` & `semantha_sdk-7.1.1/PKG-INFO`
