# Comparing `tmp/surfkit-0.1.89.tar.gz` & `tmp/surfkit-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "surfkit-0.1.89.tar", max compression
+gzip compressed data, was "surfkit-0.1.9.tar", max compression
```

## Comparing `surfkit-0.1.89.tar` & `surfkit-0.1.9.tar`

### file list

```diff
@@ -1,27 +1,13 @@
--rw-r--r--   0        0        0     1069 2024-04-09 16:39:37.152115 surfkit-0.1.89/LICENSE
--rw-r--r--   0        0        0      270 2024-04-03 02:13:16.594885 surfkit-0.1.89/README.md
--rw-r--r--   0        0        0      717 2024-04-25 22:14:19.697760 surfkit-0.1.89/pyproject.toml
--rw-r--r--   0        0        0     1725 2024-04-25 22:12:14.558746 surfkit-0.1.89/surfkit/agent.py
--rw-r--r--   0        0        0      602 2024-04-09 16:39:37.166082 surfkit-0.1.89/surfkit/cli/init.py
--rw-r--r--   0        0        0     6668 2024-04-25 17:18:51.486625 surfkit-0.1.89/surfkit/cli/main.py
--rw-r--r--   0        0        0    10733 2024-04-16 17:55:09.920080 surfkit-0.1.89/surfkit/cli/templates/agent.py
--rw-r--r--   0        0        0        0 2024-04-09 16:39:37.166494 surfkit-0.1.89/surfkit/cli/templates/device.py
--rw-r--r--   0        0        0     2053 2024-04-17 19:36:14.985684 surfkit-0.1.89/surfkit/config.py
--rw-r--r--   0        0        0     2007 2024-04-17 19:23:41.286231 surfkit-0.1.89/surfkit/db/conn.py
--rw-r--r--   0        0        0      982 2024-04-17 16:29:32.098357 surfkit-0.1.89/surfkit/db/models.py
--rw-r--r--   0        0        0      238 2024-04-17 19:35:04.174976 surfkit-0.1.89/surfkit/env.py
--rw-r--r--   0        0        0      993 2024-04-03 16:40:15.124046 surfkit-0.1.89/surfkit/hub.py
--rw-r--r--   0        0        0     9138 2024-04-25 22:16:23.555559 surfkit-0.1.89/surfkit/llm.py
--rw-r--r--   0        0        0     2413 2024-04-17 16:28:56.465927 surfkit-0.1.89/surfkit/models.py
--rw-r--r--   0        0        0     3034 2024-04-25 17:18:59.281584 surfkit-0.1.89/surfkit/runtime/agent/base.py
--rw-r--r--   0        0        0     7381 2024-04-25 17:19:06.360421 surfkit-0.1.89/surfkit/runtime/agent/docker.py
--rw-r--r--   0        0        0    27130 2024-04-25 17:19:11.347240 surfkit-0.1.89/surfkit/runtime/agent/kube.py
--rw-r--r--   0        0        0      910 2024-04-19 03:20:06.559203 surfkit-0.1.89/surfkit/runtime/agent/load.py
--rw-r--r--   0        0        0     1425 2024-04-11 22:52:18.482166 surfkit-0.1.89/surfkit/runtime/container/base.py
--rw-r--r--   0        0        0     5983 2024-04-16 16:34:59.842004 surfkit-0.1.89/surfkit/runtime/container/docker.py
--rw-r--r--   0        0        0    16077 2024-04-11 22:50:31.352813 surfkit-0.1.89/surfkit/runtime/container/kube.py
--rw-r--r--   0        0        0     1028 2024-04-11 16:49:49.850218 surfkit-0.1.89/surfkit/runtime/container/load.py
--rw-r--r--   0        0        0      402 2024-04-11 18:32:09.170609 surfkit-0.1.89/surfkit/runtime/vm/base.py
--rw-r--r--   0        0        0     9920 2024-04-17 20:04:44.519945 surfkit-0.1.89/surfkit/types.py
--rw-r--r--   0        0        0      793 2024-04-25 20:53:50.784539 surfkit-0.1.89/surfkit/util.py
--rw-r--r--   0        0        0     1262 1970-01-01 00:00:00.000000 surfkit-0.1.89/PKG-INFO
...
### Comparing `surfkit-0.1.89/surfkit/db/conn.py` & `surfkit-0.1.9/surfkit/db/conn.py`
...
### Comparing `surfkit-0.1.89/surfkit/db/models.py` & `surfkit-0.1.9/surfkit/db/models.py`
...
### Comparing `surfkit-0.1.89/surfkit/hub.py` & `surfkit-0.1.9/surfkit/hub.py`

 * *Files identical despite different names*

### Comparing `surfkit-0.1.89/surfkit/models.py` & `surfkit-0.1.9/surfkit/models.py`
...
### Comparing `surfkit-0.1.89/surfkit/types.py` & `surfkit-0.1.9/surfkit/types.py`
