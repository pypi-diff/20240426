# Comparing `tmp/bec_ipython_client-2.7.1.tar.gz` & `tmp/bec_ipython_client-2.7.2.tar.gz`
...
### Comparing `bec_ipython_client-2.7.1/PKG-INFO` & `bec_ipython_client-2.7.2/PKG-INFO`
