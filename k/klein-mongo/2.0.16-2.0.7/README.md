# Comparing `tmp/klein_mongo-2.0.16.tar.gz` & `tmp/klein_mongo-2.0.7.tar.gz`
...
### Comparing `klein_mongo-2.0.16/src/klein_mongo/connect.py` & `klein_mongo-2.0.7/src/klein_mongo/connect.py`
