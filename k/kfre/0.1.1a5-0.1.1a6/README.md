# Comparing `tmp/kfre-0.1.1a5.tar.gz` & `tmp/kfre-0.1.1a6.tar.gz`
...
## Comparing `kfre-0.1.1a5.tar` & `kfre-0.1.1a6.tar`
...
### Comparing `kfre-0.1.1a5/PKG-INFO` & `kfre-0.1.1a6/PKG-INFO`
...
### Comparing `kfre-0.1.1a5/setup.py` & `kfre-0.1.1a6/setup.py`
...
### Comparing `kfre-0.1.1a5/src/kfre.egg-info/PKG-INFO` & `kfre-0.1.1a6/src/kfre.egg-info/PKG-INFO`
